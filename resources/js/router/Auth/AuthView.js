...
//로그인
        <LoginForm>
          ...
          <div style={{}}>
            <Img_center>
              <Link to="/">
                <img src="/icon/title2_black.png" style={{width:"250px", marginBottom:"10px"}}/>
              </Link>
            </Img_center>
          </div>
...
//회원가입
        <RegisterForm>
          ...
          <Img_center>
            <Link to="/">
              <img src="/icon/title2_black.png" style={{width:"350px", marginBottom:"10px"}}/>
            </Link>
          </Img_center>
          <h2 style={{fontWeight:"bold", color:"black"}}>{action === "login" ? "SignIn" : "SignUp"}</h2>
          {/* 제출 폼 */}
...
// 컨펌코드
        <div>
          <ConfirmForm>
            ...
            <Img_center>
              <Link to="/">
                <img src="/icon/title2_black.png" style={{width:"250px"}}/>
              </Link>
            </Img_center>
            <h2>승인코드 입력</h2>
            <form onSubmit={handleSubmit(onSubmit)}>
